# Анализ временных характеристик работы ADS-B

## Описание
Программа для парсинга, анализа и визуализации логов ADS-B. После обработки файла программа показывает сводную таблицу по всем бортам и запускает окно с интерактивными графиками для детального анализа.

---
## Описание работы
При запуске программа обрабатывает указанный файл логов и выводит сводную таблицу. Сразу после этого открывается окно с графиками для первого борта из списка.
...
* **REG 08** — опознавательный код и категория
    - в полете
    - на земле при высокой частоте
    - на земле при низкой частоте
...
* **Кнопки "Графики" / "Гистограммы"** — переключение между графиками и гистограммами.
